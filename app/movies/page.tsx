    ...
    <div className="min-h-screen pt-18 px-4 md:px-8 lg:px-14 pb-20">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          {!loading && (
            <span className="text-sm text-white/30 font-medium">{movies.length} titles</span>
          )}
        </div>
...
function EmptyState() {
  return (
    <div className="flex flex-col items-center justify-center py-32 glass-card">
      ...
      <h2 className="text-lg font-bold text-white mb-1">No movies yet</h2>
      <p className="text-white/40 text-sm max-w-xs text-center">
        Connect your drive or check your scan settings to discover movies.
      </p>
    </div>
  );
}