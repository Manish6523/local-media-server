 ...
 */
function tryStandardSxxExx(name) {
 ...
 */
function tryNumberedPrefix(name) {
 ...
 */
function tryBracketedEpisodePlusSeason(name) {
...
function parseFilename(filename) {
    ...
    const type = episodeInfo ? "show" : "movie";
    let season = null;
    ...
    const junkRegex = new RegExp("\\b(" + JUNK_TAGS.map(t => t.replace(/[.*+?^${}()|[\]\\]/g, "\\$&")).join("|") + ")\\b", "i");
